...
class TechnologyNewsVC: UIViewController {
...
extension TechnologyNewsVC: ServiceCallerDelegate{
...
extension TechnologyNewsVC: UITableViewDelegate, UITableViewDataSource{
